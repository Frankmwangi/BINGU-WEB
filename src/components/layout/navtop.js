...
export function NavbarDemo() {
    return (
        <div className="relative w-full flex items-center justify-center">
            <Navbar className="top-2 bg-red-400" />
        </div>
    );
}
...
function Navbar({ className }) {
    ...
    return (
        <div
            className={cn("fixed top-10 inset-x-0 max-w-2xl  bg-red-300 mx-auto z-50", className)}
        >
            <div className="flex items-center justify-center gap-8 p-4 rounded-md bg-white">
